package com.samir.jetpackcomposemvvmclean.utils

import com.samir.jetpackcomposemvvmclean.BuildConfig

class Constants {
    companion object {
        internal const val HOME_ROUTES = "home_route"
        internal const val MY_FAVOURITE_ROUTES = "my_favourite_route"
